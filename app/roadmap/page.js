      ...
      <div className="container mx-auto mt-8 px-4 sm:px-8">
        ...
        <ul className="list-none p-0">
          ...
          <li className="mb-8 transition-transform transform hover:scale-105">
            <div className="bg-white p-4 rounded shadow">
              <h2 className="text-lg text-[#191970] font-semibold mb-2">
                INITIAL DEVELOPMENT & TESTNET DEPLOYMENT - Q1 2024 (Feb - March)
              </h2>
              <ul className="list-disc ml-4">
                <li className="text-gray-600 mb-2">
                  Designing the smart contract architecture for encrypted voting
                </li>
                <li className="text-gray-600 mb-2">Deploying on Ten Testnet</li>
                <li className="text-gray-600 mb-2">
                  Designing and developing a user-friendly interface for Encrypten
                </li>
                <li className="text-gray-600 mb-2">
                  Feedback on the initial smart contract design and functionality.
                </li>
          ...
          <li className="mb-8 ml-4 transition-transform transform hover:scale-105">
            <div className="bg-white p-4 rounded shadow">
              <h2 className="text-lg text-[#191970] font-semibold mb-2">
                SECURITY AUDITS & COMMUNITY ENGAGEMENTS - Q2 2024 (APRIL - JUNE)
              </h2>
              <ul className="list-disc ml-4">
                <li className="text-gray-600 mb-2">
                ...
                <li className="text-gray-600">
                  Building and fostering a vibrant community around Encrypten{" "}
                </li>
              </ul>
            </div>
          </li>
          ...
          <li className="mb-8 ml-8 transition-transform transform hover:scale-105">
            <div className="bg-white p-4 rounded shadow">
              <h2 className="text-lg text-[#191970] font-semibold mb-2">
                CONTINUAL IMPROVEMENT AND UPGRADES (Ongoing) - Q3 2024 (JULY -
                SEPTEMBER)
              </h2>
              <ul className="list-disc ml-4">
                <li className="text-gray-600 mb-2">
                ...
                <li className="text-gray-600 mb-2">
                  Ensuring ongoing security and reliability of the Encrypten
                  platform
                </li>
                <li className="text-gray-600">
